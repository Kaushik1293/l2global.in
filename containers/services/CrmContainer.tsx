        ...
        <div>
            ...
            <div className=' pt-2 md:pt-8 lg:pt-12'>
                <HeroCTA
                    ...
                    heading="Ready to Get More From Salesforce?"
                    description="Partner with L2 Global for Salesforce CRM consulting, implementation and rescue projects that actually get adopted."
                    primaryBtnText="Book a Salesforce CRM Consultation"
