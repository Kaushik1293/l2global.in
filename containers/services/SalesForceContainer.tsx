  ...
  },
  {
    ...
    return (
        <div>
            ...
            <ServiceHeroSection
                image={sapImg}
                sectionTitle={'Salesforce Solutions'}
                titleBefore={'Scalable & Intelligent'}
                titleAfter={'Solutions'}
                linearText={'Salesforce'}
                description={'Empower your business with Salesforce-driven transformation. From CRM implementation to automation and AI-powered insights, we help you streamline operations, boost customer engagement, and drive measurable growth.'}
                tag1={'Certified Salesforce Experts'} tag2={'End-to-End CRM Solutions'} tag3={'24/7 Support'} />
            ...
            <ServiceAboutSection
                image={sapAboutImg}
                titleBefore={'Why'}
                titleAfter={'Integration Matters'}
                linearText={'Salesforce'}
                description={'Salesforce enables businesses to centralize customer data, automate workflows, and gain real-time insights across sales, marketing, and service operations. Our Salesforce experts help you unlock the full potential of CRM with seamless integrations, improved efficiency, and scalable solutions tailored to your business needs.'}
                features={features}
            />
...
export default SalesForceContainer