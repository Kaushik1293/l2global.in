...
import heroImage from '@/public/assets/web/services/education-hero.png'
import ServiceSubHero from '@/components/web/ServiceSubHero'
import subheroImg from '@/public/assets/web/services/education-subhero.png'
...
import developerImg from '@/public/assets/web/services/education-developer.png'
  ...
  return (
    <div>
      ...
      <div>
        <HeroSection
          label="Education"
          title="Innovating Education Solutions"
      ...
      <div>
        <ServiceSubHero
          ...
          description={
            <>
              We craft digital tools that reshape how education works today.
              From online classrooms to mobile apps, our solutions inspire growth.
              L2 Global combines creativity and technology for seamless learning.
              Helping educators and students connect in smarter ways.
              L2 Global empowers institutions with scalable, future-ready technology.
            </>
          }
