...
import heroImage from '@/public/assets/web/services/health-care-hero.png'
import ServiceSubHero from '@/components/web/ServiceSubHero'
import subheroImg from '@/public/assets/web/services/health-care-subhero.png'
...
import developerImg from '@/public/assets/web/services/health-care-developer.png'
  ...
  return (
    <div>
      ...
      <div>
        <HeroSection
          label="Health Care"
          title="Innovating Healthcare Solutions"
          description="L2 Global Technology Ltd. develops advanced healthcare software that streamlines patient care, enhances hospital management, and meets international medical standards."
          image={heroImage}
        />
      </div>
      ...
      <div data-aos="fade-up" >
        <ServiceSubHero
          label="Health Care Software Development Services"
          title="Smart Healthcare Solutions Built for the Future"
          description={
            <>
              We design intelligent, secure, and scalable healthcare software that improves
              operational efficiency and patient outcomes. From hospital management
              systems to telemedicine platforms, our solutions empower healthcare providers
              to deliver better, faster, and more connected care. L2 Global blends innovation
              and technology to create future-ready digital ecosystems for the healthcare
              industry.
            </>
          }
