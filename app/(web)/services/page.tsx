...
export const metadata = {
  ...
  description:
    ...
    ' AWS, Oracle, data science and web development for UK, USA and Gulf businesses.',
  alternates: { canonical: 'https://l2global.in/services' },
  openGraph: {
    title: 'Our Services | L2 Global Technologies',
    description: 'Salesforce, SAP, MuleSoft, cloud, data science and web development. UK · USA · UAE. Free consultation.',
  ...
  return (
    <div>
      ...
      <ServiceLocalSchema
        ...
        description='Salesforce, SAP, MuleSoft, cloud, data science and web development consultants for UK, USA and Gulf enterprises.'
        cities={[
