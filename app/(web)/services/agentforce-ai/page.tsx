...
export const metadata = {
  title: 'Salesforce Agentforce AI | UK, USA & UAE',
  description:
  ...
  openGraph: {
    ...
    description: 'Autonomous Salesforce AI agents for sales and service. UK · USA · UAE & Gulf. Free consultation.',
  ...
  return (
    <div>
      ...
      <ServiceLocalSchema
        ...
        description='Certified Salesforce Agentforce AI implementation consultants for UK, USA and Gulf enterprises.'
        cities={[
