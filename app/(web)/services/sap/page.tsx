...
export const metadata = {
  ...
  description:
    'SAP S/4HANA and RISE with SAP migration services for UK, USA and Gulf businesses.' +
  ...
  openGraph: {
    ...
    description: 'SAP S/4HANA and RISE with SAP migration experts. UK · USA · UAE & Gulf. Free consultation.',
  ...
  return (
    <div>
      ...
      <ServiceLocalSchema
        ...
        description='Certified SAP S/4HANA and RISE with SAP migration consultants for UK, USA and Gulf enterprises.'
        cities={[
